...
export default function CreditCard({ conta }) {
   ...
   return (
      <div className='dark:bg-[#1f1f1f] rounded-xl w-full mx-auto py-2 px-7 flex items-start flex-col gap-1'>
         <h2 className='dark:text-[#F0F1F5] text-black text-md font-semibold'>Cartão de crédito</h2>
         <small className='dark:bg-[#1f1f1f]'>Fatura atual</small>
         <h3 className='dark:bg-[#1f1f1f]'>{cc}</h3>
         <small className="flex dark:bg-[#1f1f1f]">Limite disponível de&nbsp;&nbsp;{limite}</small>
      </div>
   )
}
